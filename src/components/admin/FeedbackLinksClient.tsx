...
interface FeedbackLinksClientProps {
  isAdmin: boolean
}

export default function FeedbackLinksClient({ isAdmin }: FeedbackLinksClientProps) {
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      {links.length === 0 && (
        <div className="text-center py-12">
          <p className="text-gray-500">No feedback links created yet.{isAdmin && ' Create your first one!'}</p>
        </div>
      )}
    </div>
  )
